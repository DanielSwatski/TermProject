<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SellersUserCreation.aspx.cs" Inherits="TermProject.Sellers.SellersUserCreation" %>
                        ...
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    <h2 class="fw-bold mb-2 text-uppercase">Profile Creation (Seller)</h2>
