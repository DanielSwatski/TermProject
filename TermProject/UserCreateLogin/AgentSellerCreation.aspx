<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentSellerCreation.aspx.cs" Inherits="TermProject.UserCreateLogin.AgentSellerCreation" %>
                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                ...
                                <div class="form-outline form-white mb-4">
                                    <h4>User Types</h4>
                                    <asp:DropDownList ID="ddlUserType" runat="server" disabled>
